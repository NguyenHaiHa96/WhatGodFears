...
public static class SimplePool
{
    class Pool
    {
        ...
        public void Despawn(GameUnit obj)
        {
            if (obj != null /*&& !inactive.Contains(obj)*/)
            {
                ...
                {
                    obj.Transform.SetParent(GetPool(obj).Root);
    ...
    {
        return Spawn<T>(obj, obj.Transform.localPosition, obj.Transform.localRotation, parent);
    }
    ...
    static public T Spawn<T>(GameUnit obj, Vector3 localPoint, Quaternion localRot, Transform parent) where T : GameUnit
    {
        ...
        unit.Transform.localPosition = localPoint;
        unit.Transform.localRotation = localRot;
